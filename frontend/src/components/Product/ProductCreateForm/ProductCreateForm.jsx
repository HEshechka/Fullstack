...
const ProductCreateForm = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            console.log(result);
            setSuccess(`Продукт "${result.productName}" успешно создан с ID ${result.productId}`);
            setId("");
            setProductName("");
            setDescription("");
            setPrice("");
    ...
    return (
        <form className="product-form fade-in" onSubmit={handleSubmit}>
            ...
            <button className="submit-button" type="submit" disabled={!productName || !price || !stockQuantity} >Создать новый продукт</button>
        </form>
    );
};
